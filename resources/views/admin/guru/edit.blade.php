          ...
          <div class="row">
            <div class="col-md-6">
              ...
              <div class="form-group">
                ...
                <select id="mapel_id" name="mapel_id"
                  ...
                  @foreach ($mapel as $data)
                    <option value="{{ $data->id }}" @if ($guru->mapel_id == $data->id) selected @endif>
              ...
              <div class="form-group">
                ...
                <input type="text" id="id" name="id" class="form-control" value="{{ $guru->id }}"
                  readonly>
              </div>
              <div class="form-group">
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input type="text" id="nip" name="nip" onkeypress="return inputAngka(event)"
                  value="{{ $guru->nip }}" class="form-control @error('nip') is-invalid @enderror" disabled>
              </div>
              <div class="form-group">
