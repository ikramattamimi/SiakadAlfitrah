              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="text" id="no_induk" name="no_induk"
                    value="{{ Auth::user()->siswa(Auth::user()->no_induk)->no_induk }}" class="form-control" disabled>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <select id="jk" name="jk"
                    ...
                    <option value="">-- Pilih Jenis Kelamin --</option>
                    <option value="L" @if (Auth::user()->siswa(Auth::user()->no_induk)->jk == 'L') selected @endif>Laki-Laki</option>
                    <option value="P" @if (Auth::user()->siswa(Auth::user()->no_induk)->jk == 'P') selected @endif>Perempuan</option>
                  </select>
                </div>
                <div class="form-group">
                  <label for="tmp_lahir">Tempat Lahir</label>
              ...
              <div class="col-md-6">
                ...
                <div class="form-group">
                  ...
                  <select id="kelas_id" name="kelas_id"
                    ...
                    @foreach ($kelas as $data)
                      <option value="{{ $data->id }}" @if (Auth::user()->siswa(Auth::user()->no_induk)->kelas_id == $data->id) selected @endif>
                ...
                <div class="form-group">
                  ...
                  <input type="text" id="telp" name="telp"
                    ...
                    onkeypress="return inputAngka(event)" class="form-control @error('telp') is-invalid @enderror">
                </div>
                <div class="form-group">
                  <label for="tgl_lahir">Tanggal Lahir</label>
                  <input type="date" id="tgl_lahir" name="tgl_lahir"
