          ...
          <div class="row">
            ...
            <div class="col-md-6">
              @if (Auth::user()->role == 'Guru')
                ...
                <img src="{{ asset(Auth::user()->guru(Auth::user()->id_guru)->foto) }}" class="img img-responsive"
                  alt="" width="30%" />
              @else
                <input type="hidden" name="role" value="{{ Auth::user()->role }}">
                <img src="{{ asset(Auth::user()->siswa(Auth::user()->no_induk)->foto) }}" class="img img-responsive"
                  alt="" width="30%" />
              @endif
            </div>
          </div>
